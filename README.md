...
var transaction = qreditjs.transaction.createTransaction("AGihocTkwDygiFvmg6aG8jThYTic47GzU9", amount, null, "passphrase", "secondPassphrase");
```
...
```js
{
  ...
  fee: 100000000, // 0.1 Qredit expressed as an integer value.
...
var nethash;
$.ajax({
  url: "https://api.qredit.io/peer/transactions/",
  data: JSON.stringify({}),
  dataType: "json",
  method: "POST",
  headers: {
...
QreditJS is licensed under the MIT License - see the [LICENSE](./LICENSE) file for details.
# qredit-js
# qredit-js
# qredit-js
# qredit-js
