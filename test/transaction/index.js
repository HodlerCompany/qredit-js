...
describe("transaction.js", function () {
  ...
  var transaction = qreditjs.transaction;
  ...
  describe("#createTransaction", function () {
    ...
    it("should create transaction without second signature from keys", function () {
      var secretKey = qreditjs.ECPair.fromSeed("secret");
  ...
  describe("createTransaction and try to tamper signature", function () {
    ...
    it("should not validate overflown signatures", function () {
      ...
      var old_transaction = qreditjs.transaction.createTransaction('PVB1zsuWTTWEBGSSGsaQ8eDjTVy475WJq8', 1, null, 'randomstring');
      ...
      */
      ...
      // console.log("TXID " + qreditjs.crypto.getId(old_transaction));
      // console.log("VERIFY " + qreditjs.crypto.verify(old_transaction));
      // console.log("SIG " + old_transaction.signature + "\n");

      qreditjs.crypto.verify(old_transaction).should.equal(true);
      ...
      qreditjs.crypto.verify(old_transaction).should.equal(false);
  ...
  describe("#createTransaction with second secret", function () {
    ...
    var keys = qreditjs.crypto.getKeys(secondSecret);
    ...
    describe("returned transaction", function () {
      ...
      it("should be second signed correctly", function () {
        var result = qreditjs.crypto.verifySecondSignature(trs, keys.publicKey);
        (result).should.equal(true);
      });
