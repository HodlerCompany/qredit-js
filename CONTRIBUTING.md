# BOUNTY Program
Qredit has a bounty program for all accepted PR (Pull Requests) for this repository

More information can be found at https://blog.ark.io/ark-github-development-bounty-113806ae9ffe

Before pushing PR, please [jump in our slack #development](https://qredit.io/go/slack) channel in order to discuss your contributions or to connect with other Qredit Developers.
...
- create something new for QREDIT.
